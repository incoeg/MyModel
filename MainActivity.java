package com.incoeg.githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showSelectedGit(Git git) {
        ...
        //ini problemnya git.setPhoto(dataPhoto.getResourceId(i, -1)); saya ganti jadi ini bisa git.setPhoto(git.getPhoto()); ato git.getPhoto();
        git.getPhoto();
        git.getName();
        git.getUsername();
        git.getLocation();
